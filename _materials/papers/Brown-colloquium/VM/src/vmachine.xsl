...
<xsl:stylesheet version="1.1" exclude-result-prefixes="tei"
  ...
  "true" to "false" below -->
   ...
   <xsl:template name="htmlHead">
      <head>
         <title>
            ...
            <xsl:text> Decameron VI, 10</xsl:text>
         </title>
      ...
      <div class="panel" id="notesPanel">
         ...
         <div class="panelBanner">
            <img class="closePanel" onclick="hideNotesPanel();" alt="X"
               src="../vm-images/closePanel.gif"/> Textual Notes </div>
   ...
   <xsl:template
      match="tei:head|tei:epigraph|tei:div|tei:div1|tei:div2|tei:div3|tei:div4|tei:div5|tei:div6|tei:div7|tei:div8|tei:lg|tei:p">
      <div>
         <xsl:attribute name="class">
      ...
      <xsl:choose>
         <xsl:when test="not(ancestor::tei:rdgGrp)">
            <span>
               ...
               <xsl:attribute name="style">
                  <xsl:text>color:#ff1b52;</xsl:text>
               </xsl:attribute>
               <xsl:apply-templates/>
            </span>
         </xsl:when>
