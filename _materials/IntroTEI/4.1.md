...
El valor de los elementos es libre, con lo cual nada nos impide señalarlo en otra lengua, por ejemplo: `<hi rend="cursiva">Palabra o frase en cursiva</hi>`.
...
*   [`<list>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-list.html) secuencia de ítems que conforman una lista
*   [`<item>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-item.html) un componente de una lista
*   [`<label>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-label.html) etiqueta asociada a un ítem
...
El elemento [`<note>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-note.html) tiene una serie de atributos que nos serán de gran utilidad, entre ellos destacamos:
...
{% highlight ruby %}
<p>Historia y organización<note n="1">Todas las discusiones e informaciones relativas entorno a TEI desde sus inicios se encuentran en el repositorio de la lista TEI</note></p>
{% endhighlight %}

<u>Opción 2</u>
{% highlight ruby %}
<p>Historia y organización<ref target="nota1" xml:id="referencia1">1</ref></p>  
<p>....</p>
[...]
<div type="notas">  
...
*   [`<index>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-index.html) marca una entrada de índice, puede llevar <span class="code">@indexName</span>; en su interior pueden anidarse diferentes índices.  

*   [`<term>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-term.html) marca un término en el interior del índice.
...
<p>
  ...
  <term xml:id="PJ">Pepita</term></index> tendrá veinte años; es viuda; sólo tres años estuvo casada. Era hija de doña <index indexName="Personajes"><term xml:id="FG">Francisca Gálvez</term></index>, viuda, como Vd. sabe, de un capitán retirado.
</p>
{% endhighlight %}
...
*   [`<ptr>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-ptr.html) (_pointer_) un indicador hacia otra localización
*   [`<ref>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-ref.html) (_reference_) define una referencia hacia otra localización, normalmente contiene un texto que funciona como el enlace. Ambos suelen utilizar, entre otros, el atributo `@target` que toma la forma de una referencia URI.
...
Como ocurre en la edición de fuentes escritas, a veces debemos señalar el proceso de constitución de un texto en sus diferentes fases (copistas, editores papel, editor digital, etc.). Para recoger las intervenciones editoriales disponemos de una serie de elementos básicos que podemos utilizar en todos los documentos TEI. Para entender la codificación de estos fenómenos debemos visualizar la intervención como una unidad en la que hay etapas o elementos diferentes. El elemento encargado de recoger estos marcados editoriales alternativos es [`<choice>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-choice.html), y puede utilizarse en los siguientes casos:

*   Corrección de errores: ante un error, se utiliza el elemento [`<sic>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-sic.html) para marcar el error aparente; con el elemento [`<corr>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-corr.html), en cambio, se recoge la corrección de dicho error:

{% highlight ruby %}
<p>Hasta cinco mujeres han venido a verme que 
   <choice><sic>todos</sic><corr>todas</corr></choice>
   han sido mis amas y me han abrazado y besado.</p>
{% endhighlight %}

*   Regularización de formas ortográficas: la forma original que aparece en el texto se marca con el elemento [`<orig>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-orig.html), mientras que su forma regularizada, con el elemento [`<reg>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-reg.html):

{% highlight ruby %}
<choice><orig>Comiença</orig><reg>Comienza</reg></choice> la  
 <choice><orig>ystoria</orig><reg>historia</reg></choice>...
{% endhighlight %}

*   Abreviatura: la forma abreviada aparece en el elemento [<abbr>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-abbr.html), mientras que la forma expandida bajo [`<expan>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-expan.html):

{% highlight ruby %}
<p>...un largo 
    <choice><abbr>etc.</abbr><expan>etcétera</expan></choice>
</p>
{% endhighlight %}
...
*   [`<add>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-add.html): adición al texto, como por ejemplo una glosa marginal.
*   [`<del>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-del.html): una eliminación en el texto, como una tachadura.
...
*   [`<unclear>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-unclear.html): indica una lectura dudosa.
...
*   [`<milestone>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-milestone.html): marca un punto límite separando cualquier tipo de sección de un texto.  

* [`<gb>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-gb.html) (_gatherin<span face="times new roman,times,serif">g begins</span>_) puede indicar el inicio o final de la folación de un manuscrito, por ejemplo donde empieza y donde acaba un cuaderno.
* [`<pb>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-pb.html) (_page break_): indica el cambio de página.
* [`<lb>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-lb.html) (_line break_): indica el cambio de línea.  
* [`<cb>`](http://www.tei-c.org/release/doc/tei-p5-doc/es/html/ref-cb.html) (_column break_): indica el cambio de columna  
